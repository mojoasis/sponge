...
const { resolve, resolvePath } = (0, _kit.createResolver)("file:///Users/mojito/Code/sponge/atidraw-main/node_modules/.pnpm/@nuxthub+core@0.10.3_@netlify+blobs@9.1.2_@vercel+blob@2.0.0_aws4fetch@1.0.20_db0@0.3.4_ebcb6a3d49198cc6e2924600cf7bc032/node_modules/@nuxthub/core/dist/module.mjs");
...
async function generateDatabaseSchema(nuxt, hub) {
  ...
  if (nuxt.options.dev && !nuxt.options._prepare) {
    ...
    watcher.on("all", async (event, path) => {
      ...
      await (0, _lib.buildDatabaseSchema)(nuxt.options.buildDir, { relativeDir: nuxt.options.rootDir });
    });
  ...
  nuxt.options.alias ||= {};
  nuxt.options.alias["hub:db:schema"] = (0, _pathe.join)(nuxt.options.buildDir, "hub/db/schema.mjs");
}
...
`;
  ...
  const databaseTemplate = (0, _kit.addTemplate)({
    filename: "hub/db.mjs",
    getContents: () => drizzleOrmContent,
    write: true
  });
  nuxt.options.alias["hub:db"] = databaseTemplate.dst;
  (0, _kit.addServerImports)({ name: "db", from: "hub:db", meta: { description: `The ${driver} database client.` } });
  (0, _kit.addServerImports)({ name: "schema", from: "hub:db", meta: { description: `The database schema object` } });
}
...
function setupKV(nuxt, hub, deps) {
  ...
  const template = (0, _kit.addTemplate)({
    filename: "hub/kv.mjs",
...
`,
  ...
  (0, _kit.addServerImports)({ name: "kv", from: "hub:kv", meta: { description: `The Key-Value storage instance.` } });
  (0, _kit.addTypeTemplate)({
...
`,
  ...
  (0, _kit.addServerImports)({ name: "blob", from: "hub:blob", meta: { description: `The Blob storage instance.` } });
  (0, _kit.addServerImports)({ name: "ensureBlob", from: "hub:blob", meta: { description: `Ensure the blob is valid and meets the specified requirements.` } });
  (0, _kit.addTypeTemplate)({
...
async function launchDrizzleStudio(nuxt, hub) {
  ...
  try {
    ...
    const { schema } = await ((specifier) => new Promise((r) => r(`${specifier}`)).then((s) => jitiImport(s).then((m) => _interopRequireWildcard(m))))(nuxt.options.alias["hub:db"]);
